...
public class HospitalController {
    ...
    public ResponseEntity<List<CamaResponseDTO>> listarCamasPorDependecia(@PathVariable Long idHospital,@PathVariable Long idDependencia){
    ...
    public ResponseEntity<Void> asignarCamaAHospital(@PathVariable Long idHospital, @PathVariable Long idCama, @RequestBody DependenciaDTO dependenciaDTO){
